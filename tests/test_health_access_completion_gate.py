...
def test_completion_gate_covers_strict_jla_protocol():
    gate = _load("completion_gate.yaml")
    assert gate["module"] == "health_access"
...
def test_module_cannot_claim_complete_with_open_gate():
...
def test_current_gate_records_real_acquisition_and_publication_gaps():
