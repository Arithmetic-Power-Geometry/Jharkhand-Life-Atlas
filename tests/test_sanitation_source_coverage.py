...
def test_sanitation_source_coverage_includes_registered_sources_and_candidates():
...
def test_sanitation_unacquired_evidence_is_never_exposed_as_published():
    coverage = load_coverage()
...
def test_sanitation_candidate_gate_remains_fail_closed():
