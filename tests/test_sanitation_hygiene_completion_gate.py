...
MODULE = ROOT / "modules" / "sanitation_hygiene"
...
def test_sanitation_completion_gate_covers_strict_jla_protocol():
    gate = _load("completion_gate.yaml")
    assert gate["module"] == "sanitation_hygiene"
...
def test_sanitation_cannot_claim_complete_with_open_gate():
...
def test_current_gate_records_real_sanitation_publication_gaps():
