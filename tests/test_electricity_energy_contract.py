...
MODULE = ROOT / "modules" / "electricity_energy"
...
def test_module11_is_fail_closed_and_dependency_safe():
    module = _yaml("module.yaml")
    assert module["id"] == "electricity_energy"
...
def test_module11_publication_gate_starts_closed():
...
def test_module11_sources_do_not_claim_unacquired_payloads():
...
def test_module11_privacy_boundary_blocks_person_level_energy_records():
    ...
    for forbidden in ["consumer names", "account numbers", "billing histories", "person-level"]:
