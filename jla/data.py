...
def places():
    return read_csv(DATA_DIR / "curated" / "core_geography" / "places.csv")
...
def research_bundle(data_df, source_df, variable_df, name="JLA_extract") -> bytes:
    ...
    with zipfile.ZipFile(mem, "w", zipfile.ZIP_DEFLATED) as z:
        ...
        z.writestr("README.txt", "Jharkhand Life Atlas research extract. Cite JLA and each underlying source listed in sources.csv. Missing values are not zero.\n")
