...
hero("Admin", "Validate the platform and generate the next module folder. Admin credentials are read from Streamlit Secrets and are never stored in the public repository.", ["Secrets-only login", "Integrity checks", "Module Builder"])
